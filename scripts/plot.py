...
# and compares the true lake volume change to the volume change estimated from
...
import numpy as np
from params import tol,t_final,nt_per_cycle,nt,t_period,Hght,Lngth,Cexp
import subprocess
...
dH -= dH[0]                                         # subtract off far-field change
...
plt.xticks(fontsize=16)
plt.yticks(fontsize=16)
plt.ylabel(r'$\Delta h - \Delta h_\infty$ (m)',fontsize=20)
